...
import { useBlogs } from '../../graphql/hooks';
    ...
    return (
        <>
            <div className='px-3'>
                ...
                <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full p-4'>
            ...
            <div className='p-3'>
                <section className='blog-cards bg-slate-100 rounded grid grid-cols-1 md:grid-cols-3 gap-2'>
                    {blogs.slice(4).map((blog: Blog, index: number) => (
    ...
    return (
        ...
        >
            <article className='md:col-span-1 flex flex-col px-3 md:px-6'>
                ...
                <h1 className='text-3xl mb-2 font-thin text-center'>
                    {blog.title}
                </h1>
    ...
    return (
        ...
        >
            <article className=' p-2 grid grid-cols-3 gap-2'>
                ...
                <p className='col-span-3 text-gray-400 text-lg'>
                    {blog.summary}
                </p>
            </article>
        </Link>
